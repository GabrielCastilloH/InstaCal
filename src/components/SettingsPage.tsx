    ...
    <div className="settings-container">
      ...
      <div className="settings-table">
        <button className="settings-row" onClick={() => onNavigate('help')}>
          <span className="settings-row-icon"><InfoIcon /></span>
          <span className="settings-row-label">Help</span>
          <span className="settings-row-chevron"><ChevronRight /></span>
        </button>
        <button className="settings-row" onClick={() => onNavigate('preferences')}>
          <span className="settings-row-icon"><PreferencesIcon /></span>
          <span className="settings-row-label">Preferences</span>
          <span className="settings-row-chevron"><ChevronRight /></span>
        </button>
        <button className="settings-row" onClick={() => onNavigate('coffee')}>
          <span className="settings-row-icon"><CoffeeIcon /></span>
